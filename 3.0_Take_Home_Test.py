...
# but I will definitely not ask another person except the instructor. Signed: Enter name here!
...
# 3. If I uncommented the following lines of code what would be their output?
#print (2/3)
#print (2//3)
...
#     PV=nRT
#     where n is the number of moles, T is the absolute temperature, V is the
...
# 14. Assume radius has been defined.
#    This code runs, but isn't very good. Explain the mistake in the following code:
x=3.14
pi=x
area=pi*radius**2
...
# 15. Assuming x and y are already defined, this code runs. But
